...
//在本地mock环境使用
const baseUrl = 'http://127.0.0.1:4523/m1/4713719-0-default';
//在服务器环境使用
// const baseUrl = '/api';
...
async function postFormData(url, formData, success, error = defaultError) {
  try {
    if (localStorage.getItem('Token') != '') {
...
export { get, post, getNToken, postNToken, postFormData };
